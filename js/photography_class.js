    ...
    class Photograpy {
        ...
        header(){
            ...
            $(window).scroll(function(){
                ...
                if( $(window).scrollTop() > sec1ScrTop-100 && $(window).scrollTop() < sec2ScrTop-100 ){
                ...
                if( $(window).scrollTop() > sec2ScrTop-100 && $(window).scrollTop() < sec3ScrTop-100 ){
                    $('.nav-btn').eq(0).addClass('on');
                }
                else {
                    $('.nav-btn').eq(0).removeClass('on');
                ...
                if( $(window).scrollTop() > sec3ScrTop-100 && $(window).scrollTop() < sec4ScrTop-100 ){
                    $('.nav-btn').eq(0).addClass('on');
                }
                else {
                    $('.nav-btn').eq(0).removeClass('on');
                ...
                if( $(window).scrollTop() > sec6ScrTop-100 && $(window).scrollTop() < sec7ScrTop-100 ){
                    $('.nav-btn').eq(0).addClass('on');
                }
                else {
                    $('.nav-btn').eq(0).removeClass('on');
